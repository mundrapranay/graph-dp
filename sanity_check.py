...
if __name__ == '__main__':
    ...
    for bf in ['dblp_adj']:
        ...
        print(bf)
        print("CDP")
        output_file = f"/home/ubuntu/results_new/golang_results/{bf}_0_1_4_central_dp_kcore_noise_final.txt"
        approx_core_numbers_cdp = core_numbers_distribution(output_file, bf)
        print()
        print("LDP")
        output_file = f"/home/ubuntu/results_new/golang_results/{bf}_0_1_4_local_dp_kcore_noise_final.txt"
