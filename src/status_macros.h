...
#ifndef DISTRIBUTED_KCORE_BASE_STATUS_MACROS_H_
#define DISTRIBUTED_KCORE_BASE_STATUS_MACROS_H_
...
#define RETURN_IF_ERROR(expr)                                              \
  ...
  if (distributed_kcore::base::status_macro_internal::                  \
...
class StatusAdaptorForMacros {
 public:
  ...
  distributed_kcore::base::Status&& Consume() { return std::move(status_); }

 private:
  distributed_kcore::base::Status status_;
};
}  // namespace status_macro_internal
}  // namespace base
}  // namespace distributed_kcore

#endif  // DISTRIBUTED_KCORE_BASE_STATUS_MACROS_H_
